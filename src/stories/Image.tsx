...
storiesOf('Image', module)
  ...
  .add('basic image', () => (
    <div>
      ...
      inline-block so it behaves like a standard inline image. Height and width actually get applied
      to the wrapper div, and the image will get scaled/positioned within the wrapper depending on
      which props you provide.
      <br />
  ...
  .add('image fit: not provided', () => (
    <div>
      Our example image is a rectangle, so if we provide equal height and width without providing an
      imageFit prop it gets stretched:
      <br />
  ...
  .add('image fit: cover', () => (
    <div>
      Here we set imageFit: ImageFit.cover. This can be used to nicely fill the desired image area
      while hiding any overflow:
      <br />
      <Image
        source={yammerLogo}
  ...
  .add('image fit: contain', () => (
    <div>
      Here we set imageFit: ImageFit.contain, which displays the entire image within our image area
      and leaves whitespace:
      <br />
      <Image
        source={yammerLogo}
        description={yammerLogoDescription}
  ...
  .add('image fit: none', () => (
    <div>
      Here we set imageFit: ImageFit.none. This places the image at the top left of its div wrapper.
      It will render at its original size, possibly showing whitespace or hiding its overflow. This
      is generally not an option you will want to use.
      <br />
      <Image
        source={yammerLogo}
        description={yammerLogoDescription}
      ...
      <div>
        <table style={{ maxWidth: '500px' }}>
          <tbody>
            <tr>
              <td colSpan={4}>
                If you set fullWidth: true your image will grow to fit the width of its container.
                Use this option when you have a grid or some other layout component determining the
                space an image should fill. Any provided height and width will be ignored in this
                case, replaced with width: 100% and height: auto.
              </td>
            </tr>
            <tr>
  ...
  .add('load events', () => {
    ...
    return (
      <div>
        ...
        prop callback, providing a loading state of enum ImageLoadState. This example updates the
        source URL passed to the Image component when its onLoadingStateChange is called with
