...
storiesOf('ScreenreaderText', module)
  ...
  .add('default', () => (
    <div>
      There is a <strong>ScreenreaderText</strong> component with text after this visible text
      which is hidden in the browser but still available to screenreaders.
