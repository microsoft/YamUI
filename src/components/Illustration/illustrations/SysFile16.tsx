  ...
  public render() {
    return (
      ...
      >
        ...
        <path
          fill="#c8c8c8"
          d="M6 5h2v1H6zM6 10h2v1H6zM4 7h1v2H4zM9 7h1v2H9zM5 6h1v1H5zM6 7h1v1H6zM7 7h1v1H7zM7 8h1v1H7zM6 8h1v1H6zM8 6h1v1H8zM5 9h1v1H5zM8 9h1v1H8zM10 10h1v1h-1zM9 11h1v1H9zM10 12h1v1h-1zM11 11h1v1h-1z"
        />
      </svg>
    );
  }
