...
export default class Pptx extends BaseIllustration {
  public render() {
    return (
      ...
      >
        <defs>
          <linearGradient id="Pptx40-a" x1="6.099" x2="35.395" y1="4.434" y2="39.347" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
            <stop offset=".862" stopColor="#5e5e5e" stopOpacity=".063" />
            <stop offset={1} stopOpacity=".1" />
          </linearGradient>
          <linearGradient id="Pptx40-b" x1={32} x2={32} y1="13.906" y2="11.088" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#828282" stopOpacity={0} />
            <stop offset=".862" stopColor="#303030" stopOpacity=".063" />
            <stop offset={1} stopOpacity=".1" />
          </linearGradient>
          <linearGradient id="Pptx40-c" x1="26.792" x2="31.73" y1="9.708" y2="4.77" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
          ...
          <linearGradient id="Pptx40-d" x1="14.278" x2="14.657" y1="36.941" y2="33.377" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#828282" stopOpacity={0} />
            <stop offset=".997" stopOpacity=".2" />
          </linearGradient>
          <linearGradient id="Pptx40-e" x1="11.5" x2="11.5" y1="32.792" y2="12.217" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
        ...
        />
        <path fill="url(#Pptx40-a)" d="M29 2H9v10.294L3 13v19l6 .706V38h28V10z" />
        <path fill="url(#Pptx40-b)" d="M28 11h8v3h-8z" />
        <path fill="url(#Pptx40-c)" d="M29 2H9v1h19v8h8v14h1V10l-8-8z" />
        <path fill="url(#Pptx40-d)" d="M20 37H9v-4.29L20 34v3z" />
        <path fill="url(#Pptx40-e)" d="M20 34L3 32V13l17-2v23z" />
      </svg>
    );
  }
}
