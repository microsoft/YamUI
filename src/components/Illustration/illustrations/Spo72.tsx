...
export default class Spo extends BaseIllustration {
  public render() {
    return (
      ...
      >
        <defs>
          <linearGradient id="Spo72-a" x1="11.467" x2="63.639" y1="7.804" y2="69.981" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
            <stop offset=".862" stopColor="#5e5e5e" stopOpacity=".063" />
            <stop offset={1} stopOpacity=".1" />
          </linearGradient>
          <linearGradient id="Spo72-b" x1={57} x2={57} y1="24.844" y2="20.146" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#828282" stopOpacity={0} />
            <stop offset=".862" stopColor="#303030" stopOpacity=".063" />
            <stop offset={1} stopOpacity=".1" />
          </linearGradient>
          <linearGradient id="Spo72-c" x1="25.966" x2="26.798" y1="65.803" y2="58.018" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#828282" stopOpacity={0} />
            <stop offset=".862" stopColor="#303030" stopOpacity=".126" />
            <stop offset={1} stopOpacity=".2" />
          </linearGradient>
          <linearGradient id="Spo72-d" x1="21.5" x2="21.5" y1="58.75" y2="21.167" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
          ...
          <linearGradient id="Spo72-e" x1="53.792" x2="62.501" y1="23.208" y2="14.499" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
        ...
        />
        <path fill="url(#Spo72-a)" d="M52 4H16v19.387L6 25v30l10 1.613V68h50V18z" />
        <path fill="url(#Spo72-b)" d="M50 20h14v5H50z" />
        <path fill="url(#Spo72-c)" d="M37 65H16v-8.38L37 60v5z" />
        <path fill="url(#Spo72-d)" d="M37 20L6 25v30l31 5V20z" />
        <path fill="url(#Spo72-e)" d="M66 18L52 4H16v2h34v14h14v48h2V18z" />
      </svg>
    );
  }
}
