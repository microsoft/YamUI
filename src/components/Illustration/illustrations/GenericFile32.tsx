...
export default class GenericFile extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="GenericFile32-a" x1="3.084" x2="25.961" y1="3.608" y2="30.872" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
      <stop offset=".862" stopColor="#5e5e5e" stopOpacity=".063" />
      <stop offset={1} stopOpacity=".1" />
    </linearGradient>
    <linearGradient id="GenericFile32-b" x1="20.148" x2="24.114" y1="9.102" y2="5.136" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
    ...
    <linearGradient id="GenericFile32-c" x1={23} x2={23} y1="10.938" y2="9.058" gradientUnits="userSpaceOnUse">
  ...
  <path fill="url(#GenericFile32-a)" d="M27 8l-6-6H5v28h22z" />
  <path fill="url(#GenericFile32-b)" d="M5 2v1h15v6h6v15.5h1V8l-6-6H5z" />
  <path fill="url(#GenericFile32-c)" d="M20 9h6v2h-6z" />
      </svg>
    );
  }
}
