...
export default class PraiseHeartHC extends BaseIllustration {
  ...
  <path fill="#fff" d="M57.13 32.636c0 9.503-20.3 22.605-20.3 22.605S16.48 41.66 16.48 32.636c0-14.014 14.302-15.214 20.301-4.991 6.336-10.655 20.35-8.543 20.35 4.991z" />
      </svg>
    );
  }
}
