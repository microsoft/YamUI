...
export default class PraiseDiamondHC extends BaseIllustration {
  public render() {
  ...
  <path fill="#fff" d="M59.147 31.484h-45.45l9.214-10.558h25.677z" />
  <path d="M35.87 56.01L13.696 31.483h45.499z" />
  <path d="M22.911 20.638h12.863l-7.2 10.942zm12.863 0h12.862l-4.608 11.038z" />
  <path fill="#fff" d="M28.574 32.156h15.454L35.87 56.057z" />
  <path fill="none" stroke="#fff" strokeMiterlimit={10} strokeWidth=".48" d="M13.696 31.484L35.87 56.057l23.325-24.573-10.607-10.558H22.91z" />
      </svg>
    );
  }
}
