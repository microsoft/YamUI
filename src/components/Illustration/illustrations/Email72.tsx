...
export default class Email extends BaseIllustration {
  public render() {
    ...
    return (
      ...
      >
        <defs>
    <linearGradient id="Email72-a" x1="12.987" x2="59.115" y1="8.574" y2="63.547" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
      <stop offset=".862" stopColor="#5e5e5e" stopOpacity=".063" />
      <stop offset={1} stopOpacity=".1" />
    </linearGradient>
    <linearGradient id="Email72-b" x1="35.967" x2="63.967" y1="36.032" y2="8.698" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
  ...
  <path fill="url(#Email72-a)" d="M4 13h64v46H4z" />
  <path fill="url(#Email72-b)" d="M68 13H4v2h62v44h2V13z" />
      </svg>
    );
  }
}
