  ...
  public render() {
    return (
      ...
      >
        ...
        <path
          fill="#c8c8c8"
          d="M15.558 14.454A10.899 10.899 0 0 1 19 13.19v-1.01a11.912 11.912 0 0 0-4.11 1.509 3.006 3.006 0 0 1 .668.764zM11.454 18.558a3.006 3.006 0 0 1-.764-.667A11.912 11.912 0 0 0 9.18 22h1.01a10.899 10.899 0 0 1 1.264-3.442z"
        />
