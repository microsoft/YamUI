...
export default class PraisePieHC extends BaseIllustration {
  public render() {
  ...
  <g fill="#fff" transform="matrix(.47994 0 0 .47994 .018 0)">
    <path d="M76.5 42.1h-1.1c-2.1 0-3.9 1.8-3.9 3.9l.2 20.5c0 2.1 1.8 3.9 3.9 3.9h1.1c2.1 0 3.9-1.8 3.9-3.9L80.5 46c-.1-2.2-1.8-3.9-4-3.9zm5.4-8.3c0 3.4-2.7 6.1-6.1 6.2-3.4 0-6.1-2.7-6.2-6.1 0-3.4 6-14.2 6-14.2s6.2 10.7 6.3 14.1z" />
    <ellipse cx="76.2" cy="80.9" rx="34.6" ry={19} />
    <path d="M102.4 121.2H50.2l-8.7-39.3h69.6z" />
  </g>
  <path d="M19.312 38.635h37.195v1.344H19.312z" />
      </svg>
    );
  }
}
