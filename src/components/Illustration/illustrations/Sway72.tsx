...
export default class Sway extends BaseIllustration {
  public render() {
    return (
      ...
      >
        <defs>
          <linearGradient id="Sway72-a" x1="11.467" x2="63.639" y1="7.804" y2="69.981" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
            <stop offset=".862" stopColor="#5e5e5e" stopOpacity=".063" />
            <stop offset={1} stopOpacity=".1" />
          </linearGradient>
          <linearGradient id="Sway72-b" x1={57} x2={57} y1="24.844" y2="20.146" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#828282" stopOpacity={0} />
            <stop offset=".862" stopColor="#303030" stopOpacity=".063" />
            <stop offset={1} stopOpacity=".1" />
          </linearGradient>
          <linearGradient id="Sway72-c" x1="53.792" x2="62.501" y1="23.208" y2="14.499" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
          ...
          <linearGradient id="Sway72-d" x1="25.966" x2="26.798" y1="65.803" y2="58.018" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#828282" stopOpacity={0} />
            <stop offset=".862" stopColor="#303030" stopOpacity=".126" />
            <stop offset={1} stopOpacity=".2" />
          </linearGradient>
          <linearGradient id="Sway72-e" x1="21.5" x2="21.5" y1="57.75" y2="20.167" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#fff" stopOpacity={0} />
        ...
        <path fill="url(#Sway72-a)" d="M66 18L52 4H16v64h50z" />
        <path fill="url(#Sway72-b)" d="M50 20h14v5H50z" />
        <path fill="url(#Sway72-c)" d="M66 18L52 4H16v2h34v14h14v48h2V18z" />
        <path fill="#99cdc7" d="M38.75 30L26 45h25.5L38.75 30z" />
        <path
          fill="#c8c8c8"
          d="M34 48h11v2H34zm13 0h12v2H47zm-13 4h11v2H34zm13 0h12v2H47zm-13 4h11v2H34zm13 0h12v2H47z"
        />
