...
export default class VideoWatermark extends BaseIllustration {
  ...
  <path fill="#949494" d="M8 7v6l5-3-5-3zM3 13h1v1H3zM3 15h1v1H3zM3 11h1v1H3zM3 9h1v1H3zM3 7h1v1H3zM3 5h1v1H3zM16 13h1v1h-1zM16 15h1v1h-1zM16 11h1v1h-1zM16 9h1v1h-1zM16 7h1v1h-1zM16 5h1v1h-1z" />
      </svg>
    );
  }
}
