...
loadTheme({
  palette: {
    themePrimary: '#6c98d9', // $color__lake, $borderColor__focused
    neutralPrimary: '#343A41', // $textColor
    neutralSecondary: '#646d7a', // $textColor__metadata
    neutralTertiary: '#dde0e6', // $color__indieRock, $borderColor
    neutralLighter: '#f3f5f8', // $borderColor__tertiary
    neutralDark: '#dde0e6', // $color__indieRock, $borderColor
    redDark: '#d1423b', // $color__lestat
  },
  fonts: {
    tiny: fontStyles,
    xSmall: {
